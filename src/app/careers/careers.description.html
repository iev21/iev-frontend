export const softwareEngineerDescription: string = `
    <p style="font-weight: bold; color: #333;">As a Software Engineer at our company, you will be responsible for designing, developing, and maintaining high-quality software solutions. 
    ...
    <p style="font-style: italic;">Key Responsibilities:
    ...
    <p style="color: blue;">Requirements:
    ...
    - Experience with web development frameworks (e.g., Angular, React, Vue.js) and backend technologies (e.g., Node.js, Spring Boot).
    ...
    <p style="font-size: 1.1em;">Join our team and be part of a dynamic and innovative environment 
